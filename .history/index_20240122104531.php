...
$router
    ...
    ->get('/admin/add_user', [Controller::class, 'adminAddProduct'])
    ->post('/admin/add_user', [Controller::class, 'adminAddProduct'])
    ->get('/admin/edit_user', [Controller::class, 'adminEditProduct'])
    ->get('/admin/update_user', [Controller::class, 'adminUpdateProduct'])
    ->post('/admin/update_user', [Controller::class, 'adminUpdateProduct'])
    ->get('/admin/delete_user', [Controller::class, 'adminDeleteProduct'])
    //+Order

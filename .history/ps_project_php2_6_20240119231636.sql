...
-- Thời gian đã tạo: Th1 19, 2024 lúc 04:16 PM
...
--
-- Cơ sở dữ liệu: `ps_project_php2_5`
--
...
CREATE TABLE `ps_order` (
  ...
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'pending; cofirm; delivering; complete; delivering fail; cancelled 	',
...
(8, 'dfbfdb', '435', 'rteb', '3t35rde54gse45', 3452, NULL, '416134988_1331954691537232_1547475080054229849_n.jpg', '2024-01-19');

        ...
        try {
            ...
            if (is_array($cartItems)) {
                foreach ($cartItems as $item) {
                    ...
                    $stmt = $conn->prepare("INSERT INTO ps_order_detail (order_id, product_id, quantity, product_price) VALUES (?, {$item['id']}, {$item['quantity']}, {$item['price']})");
            ...
            exit;
            echo "<script>console.log('Success Checkout')</script>";

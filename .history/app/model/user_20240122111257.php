...
class User
{
    ...
    public function adminUpdateUser($id, $name, $first_name, $last_name, $age, $company, $longDesc)
    {
        $conn = $this->getConnection();
        $query = "UPDATE ps_users 
              SET name = :name, first_name = :first_name, last_name = :last_name, age = :age, short_desc = :short_desc, long_desc = :long_desc
              WHERE id = :id";
        $stmt = $conn->prepare($query);
        ...
        $stmt->bindValue(':short_desc', $company, PDO::PARAM_STR);

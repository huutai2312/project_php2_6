...
class User
{
    ...
    public function adminUpdateUser($id, $name, $first_name, $last_name, $age, $company, $email)
    {
        $conn = $this->getConnection();
        $query = "UPDATE ps_users 
              SET name = :name, first_name = :first_name, last_name = :last_name, age = :age, company = :company, long_desc = :long_desc
              WHERE id = :id";
        $stmt = $conn->prepare($query);
        ...
        $stmt->bindValue(':long_desc', $email, PDO::PARAM_STR);

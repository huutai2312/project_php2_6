...
class Checkout
{
    ...
    public function saveOrder($email, $first_name, $last_name, $company, $address, $phone, $city, $country, $postal_code,)
    {
        try {
            ...
            $stmt->execute([$email, $first_name, $last_name, $company, $address, $phone, $city, $country, $postal_code,, $status, $time]);

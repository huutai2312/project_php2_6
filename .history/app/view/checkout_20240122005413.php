<?php
$subtotal = "<script>localStorage.getItem('cartItems')</script>";
$shippingFee = "<script>localStorage.getItem('cartItems')</script>";
$totalBill = "<script>localStorage.getItem('cartItems')</script>";

                                                ...
                                                <tr class="cart__table--body__items">
                                                    ...
                                                    <td class="cart__table--body__list">
                                                        <div class="quantity__box">
                                                            ...
                                                            <label>
                                                                <input type="number" name="quantity[]" class="quantity__number quickview__value--number" value="<?php echo (int)$cartItem[1]; ?>" data-counter />
                                                                <!-- Thêm input ẩn để lưu trữ giá trị mới của số lượng -->
                                                                <input type="hidden" name="product_id[]" value="<?php echo $cartItem[0]; ?>">
                                                            </label>
                                                            <button type="button" class="quantity__value quickview__value--quantity increase" aria-label="quantity value" value="Increase Value">+</button>
                                                        </div>
                                                    </td>
                                                    <td class="cart__table--body__list">
                                                    <span class="cart__price end" id="cart_price_<?php echo $cartItem[0]; ?>"><?php echo '$' . number_format((float)$cartItem[1] * (float)$cartItem[3], 0); ?></span>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else : ?>

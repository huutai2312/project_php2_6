                                    ...
                                    <tbody class="cart__table--body body-table-product">
                                        <?php foreach ($_SESSION['cart'] as $cartItem) : ?>
                                            <tr class="cart__table--body__items">
                                                ...
                                                <td class="cart__table--body__list">
                                                    <span class="cart__price">$<?php echo '$' . number_format($cartItem['product_uprice'], 2); ?></span>
                                                </td>
                                                <td class="cart__table--body__list">
                                                    <div class="quantity__box">
                                                        <button type="button" class="quantity__value quickview__value--quantity decrease" aria-label="quantity value" value="Decrease Value">-</button>
                                                        <label>
                                                            <input type="number" class="quantity__number quickview__value--number" value="<?php echo $cartItem['quantity']; ?>" data-counter />
                                                        </label>
                                                        <button type="button" class="quantity__value quickview__value--quantity increase" aria-label="quantity value" value="Increase Value">+</button>
                                                    </div>
                                                </td>
                                                <td class="cart__table--body__list">
                                                    <span class="cart__price end">$<?php echo '$' . number_format($cartItem['quantity'] * $cartItem['product_price'], 2); ?></span>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>

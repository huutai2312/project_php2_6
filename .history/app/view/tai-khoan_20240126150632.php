                            ...
                            <table class="account__table">
                                ...
                                <tbody class="account__table--body mobile__none">
                                    <tr class="account__table--body__child">
                                        ...
                                        <td class="account__table--body__child--items">COD</td>
                                        <td class="account__table--body__child--items">Pending</td>
                                        <td class="account__table--body__child--items">$40.00</td>
                                        <td class="account__table--body__child--items">
                                            <a href="/admin/edit_user?id=<?php echo $user['id']; ?>"><button class="primary__btn">Detail</button></a>
                                        </td>
                                    </tr>
                                </tbody>

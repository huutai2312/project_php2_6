...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateSubtotal() {
            ...
            // Lặp qua từng hàng sản phẩm trong bảng giỏ hàng
            ...
            // Nếu muốn gửi dữ liệu về máy chủ, bạn có thể sử dụng AJAX ở đây
        }

        // Bắt sự kiện khi số lượng hoặc giá sản phẩm thay đổi

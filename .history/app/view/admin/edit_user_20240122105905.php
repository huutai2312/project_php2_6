                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" name="password" id="input3" placeholder="Password" type="text" value="<?php echo $user['password']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                ...
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input3">Address2 <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="last_name" id="input3" placeholder="Address2" type="text" value="<?php echo $user['last_name']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">

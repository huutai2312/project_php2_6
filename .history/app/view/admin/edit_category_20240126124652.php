                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        <input class="contact__form--input" name="category_id" id="input0" placeholder="ID Category: <?php echo $category['id']; ?>" type="text" value="<?php echo $category['id']; ?>" hidden>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                ...
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" name="price" id="input2" placeholder=" Price" type="text" value="<?php echo $category['price']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input3">Quantity <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="quantity" id="input3" placeholder="Quantity" type="text" value="<?php echo $category['quantity']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">

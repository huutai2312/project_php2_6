            ...
            <div class="my__account--section__inner border-radius-10 d-flex">
                ...
                <div class="account__wrapper">
                    <div class="account__content">
                        ...
                        <form class="contact__form--inner" action="/admin/update_category?id=<?php echo $['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        <input class="contact__form--input" name="product_id" id="input0" placeholder="ID Product: <?php echo $['id']; ?>" type="text" value="<?php echo $['id']; ?>" hidden>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input1">Name <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="name" id="input1" placeholder="Name" type="text" value="<?php echo $['name']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input2">Price <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="price" id="input2" placeholder=" Price" type="text" value="<?php echo $['price']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input3">Quantity <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="quantity" id="input3" placeholder="Quantity" type="text" value="<?php echo $['quantity']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">

                                ...
                                <tbody class="account__table--body mobile__block">
                                    ...
                                    ?>
                                        <tr class="account__table--body__child">
                                            ...
                                            <td class="account__table--body__child--items">
                                                <strong>Image</strong>
                                                <span><img class="" src="public/uploads/<?php echo $category['image']; ?>" alt="product-img" width="30px"></span>
                                            </td>
                                            <td class="account__table--body__child--items">
                                                <strong>Name</strong>
                                            ...
                                            <td class="account__table--body__child--items">
                                                <strong>Price</strong>
                                                <span>$<?php echo number_format($category["price"]) ?></span>
                                            </td>
                                            <td class="account__table--body__child--items">
                                                <strong>Quantity</strong>
                                                <span><?php echo $category["quantity"] ?></span>
                                            </td>
                                            <td class="account__table--body__child--items">
                                                <strong>Date Created</strong>
                                                <span><?php echo $category["date_created"] ?></span>
                                            </td>
                                            <td class="account__table--body__child--items">

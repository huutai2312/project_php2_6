                            ...
                            <table class="account__table">
                                <thead class="account__table--header">
                                    <tr class="account__table--header__child">
                                        ...
                                        <th class="account__table--header__child--items">Company</th>
                                        <th class="account__table--header__child--items">Email</th>
                                        <th class="account__table--header__child--items">Phone</th>
                                ...
                                <tbody class="account__table--body mobile__none">
                                    ...
                                    ?>
                                        <tr class="account__table--body__child">
                                            ...
                                            <td class="account__table--body__child--items"><img class="" src="/public/uploads/<?php echo $user['image']; ?>" alt="product-img" width="30px"></td>
                                            <td class="account__table--body__child--items"><?php echo $user["name"] ?></td>
                                            <td class="account__table--body__child--items">$<?php echo number_format($user["price"]) ?></td>
                                            <td class="account__table--body__child--items"><?php echo $user["quantity"] ?></td>
                                            <td class="account__table--body__child--items"><?php echo $user["date_created"] ?></td>
                                            <td class="account__table--body__child--items">
                                                <a href="/admin/edit_product?id=<?php echo $user['id']; ?>"><button class="primary__btn">Edit</button></a>
                                                <a href="/admin/delete_product?id=<?php echo $user['id']; ?>" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này không?')"><button class="primary__btn">Delete</button></a>
                                            </td>
                                        </tr>
                                    <?php
                                        $stt++;

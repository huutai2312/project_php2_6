                    ...
                    <div class="account__content">
                        ...
                        <form class="contact__form--inner" action="/admin/update_user?id=<?php echo $user['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input3">Co <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="city" id="input3" placeholder="Co" type="text" value="<?php echo $user['city']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">

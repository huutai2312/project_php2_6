        ...
        <div class="image-list">
            ...
            foreach ($existingImages as $existingImage) {
                if ($existingImage != '.' && $existingImage != '..') {
                    echo "<img src='/public/uploads/$existingImage' onclick='selectImage(\"$existingImage\")' />";
                }
            }
            ?>
        </div>
...
<script>
    ...
    function selectImage(imageName) {
        // Xử lý logic khi người dùng chọn ảnh, có thể cập nhật trường input hoặc làm gì đó khác
        // ở đây để lưu lại ảnh đã chọn.
        alert('Selected image: ' + imageName);

        // Sau khi chọn xong, đóng modal
        closeImageModal();
    }
</script>

                                    ...
                                    ?>
                                        <tr class="account__table--body__child">
                                            ...
                                            <td class="account__table--body__child--items">
                                                <a href="/admin/edit_product?id=<?php echo $category['id']; ?>"><button class="primary__btn">Edit</button></a>
                                                <a href="/admin/delete_product?id=<?php echo $category['id']; ?>" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này không?')"><button class="primary__btn">Delete</button></a>
                                            </td>
                                        </tr>
                                    <?php
                                        $stt++;

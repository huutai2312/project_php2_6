                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <select class="contact__form--input" name="existing_image" id="input8" onchange="showImagePreview()">
                                            <?php
...
<script>
    function showImagePreview() {
        var selectElement = document.getElementById("input8");
        var selectedImage = selectElement.options[selectElement.selectedIndex].value;

        if (selectedImage !== "") {
            var imageUrl = '/public/uploads/' + selectedImage;

            // Mở cửa sổ popup và hiển thị ảnh
            var popupWindow = window.open(imageUrl, "_blank", "width=600, height=400");
            popupWindow.document.write("<img src='" + imageUrl + "' alt='Selected Image' style='width: 100%; height: 100%;'>");
        }
    }
</script>
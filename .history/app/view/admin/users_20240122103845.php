                                ...
                                <tbody class="account__table--body mobile__none">
                                    ...
                                    ?>
                                        <tr class="account__table--body__child">
                                            ...
                                            <td class="account__table--body__child--items"><?php echo $user["company"] ?></td>
                                            <td class="account__table--body__child--items"><?php echo $user["email"] ?></td>
                                            <td class="account__table--body__child--items"><?php echo $user["phone"] ?></td>
                                            <td class="account__table--body__child--items"><?php echo $user["is_admin"] ?>
                                                <?php
                                                if (condition) {
                                                    # code...
                                                }

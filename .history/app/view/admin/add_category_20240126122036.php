            ...
            <div class="my__account--section__inner border-radius-10 d-flex">
                ...
                <div class="account__wrapper">
                    <div class="account__content">
                        ...
                        <form class="contact__form--inner" action="/admin/add_category" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label">Slug <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="slug" placeholder="Quantity" type="text">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">

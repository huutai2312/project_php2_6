                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        <input class="contact__form--input" name="product_id" id="input0" placeholder="ID Product: <?php echo $product['id']; ?>" type="text" value="ID Product: <?php echo $product['id']; ?>" hidden>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                ...
                                <div class="col-12">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" name="image" id="input4" placeholder="Image" type="file" value="<?php echo $product['image']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">

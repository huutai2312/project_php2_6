                ...
                <main class="main__content_wrapper">
                    <form action="" method="post" id="checkoutForm">
                        ...
                        <div class="checkout__content--step__footer d-flex align-items-center">
                            ...
                            <a class="continue__shipping--btn primary__btn border-radius-5" href="#" onclick="submitCheckoutForm()">Finished</a>
                        </div>
                    </form>
                </main>
...
function submitCheckoutForm() {
    // Sử dụng AJAX để gửi dữ liệu form đến checkout_process.php
    $.ajax({
        type: 'POST',

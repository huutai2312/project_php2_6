<?php
$subtotal = "<script>localStorage.getItem('cartSubTotal')</script>";
$shippingFee = "<script>localStorage.getItem('cartFee')</script>";
$totalBill = "<script>localStorage.getItem('cartTotal')</script>";
$_SESSION['cartSubTotal'] = $subtotal;
$_SESSION['cartFee'] = $shippingFee;
$_SESSION['cartTotal'] = $totalBill;
?>

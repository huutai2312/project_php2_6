...
class Controller
{
    ...
    public function addtocart()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($index !== -1) {
                // Nếu sản phẩm đã tồn tại, cập nhật số lượng và kiểm tra giới hạn số lượng
                $newQuantity = $_POST['cart_quantity'][$index];
                ...
                if ($newQuantity <= 0) {
                    ...
                    $_SESSION['cart'][$index][1] = $newQuantity;
                }
            } else {
                // Nếu sản phẩm chưa tồn tại, thêm mới vào giỏ hàng
                $newQuantity = $_POST['cart_quantity'][count($_SESSION['cart']) - 1];
                $_SESSION['cart'][] = [$product_id, $newQuantity, $product_name, $product_price];
            }

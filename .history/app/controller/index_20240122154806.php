...
class Controller
{
    ...
    public function addToCart()
    {
        ...
        if (isset($_GET['id'])$_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['addToCart'])) {
...
//gắn id
  ...
  $sp= [$sp_mot[0]['id'],$sp_mot[0]['name'], $sp_mot[0]['price'],1,$sp_mot[0]['img']];
  $vitri = $gh->kiemtra($sp);
  if($vitri == -1){
      $_SESSION['giohang'][]= $sp;
  }else{
...
if(isset($_REQUEST['del'])){
  ...
  array_splice($_SESSION['giohang'],$vitri,1);
    ...
    include "../ASM_PHP2/app/view/cart.php";

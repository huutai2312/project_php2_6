...
class Controller
{
    ...
    public function adminUpdateProduct()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // Lấy đường dẫn ảnh hiện tại từ form
            $currentImage = $_POST['current_image'];

            // Kiểm tra lựa chọn của người dùng
            if ($_POST['image_source'] === 'new' && !empty($_FILES['new_image']['name'])) {
                // Nếu người dùng chọn ảnh mới và có tệp tin được chọn
                ...
                // Nếu người dùng không chọn ảnh mới hoặc không có tệp tin được chọn
